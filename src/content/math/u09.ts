    ...
    learnCards: [
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Build $6.35 with coins and bills. Each piece adds its own value to the tray.' },
            { speaker: 'kid', text: 'I will choose denominations, compare the subtotals, and check my collection.' },
          ],
          reactions: {
            strategy: { text: 'Use a denomination’s value to plan which pieces to add or remove.', pose: 'think' },
            retry: { text: 'Compare your checked total with $6.35 and adjust one denomination.', pose: 'oops' },
            milestone: { text: 'Your collection changed. Use its subtotals to plan the next piece.', pose: 'think' },
            complete: { text: 'Your collection shows $6.35, or 635 cents, using coins and bills.', pose: 'cheer' },
          },
        },
      },
      {
  ...
  },
  {
    ...
    learnCards: [
      ...
      },
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Start at 9:00 AM and add 35 minutes. Predict the end before you choose your jumps.' },
            { speaker: 'kid', text: 'I will save my prediction, move the clock with jumps, and compare the ending time.' },
          ],
          reactions: {
            strategy: { text: 'Your prediction is saved. Choose a jump that fits the time remaining.', pose: 'think' },
            retry: { text: 'That jump would pass the end. Read the minutes left and choose a smaller jump.', pose: 'oops' },
            milestone: { text: 'The clock crossed an hour. The jump record keeps track of that change.', pose: 'think' },
  ...
  },
  {
    ...
    learnCards: [
      ...
      },
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Move the marker along this quarter-inch ruler to the object’s endpoint.' },
            { speaker: 'kid', text: 'I will start at zero, count equal spaces, and check where the marker lands.' },
          ],
          reactions: {
            strategy: { text: 'Use the quarter-inch spaces between labeled whole inches.', pose: 'think' },
            retry: { text: 'Compare the checked marker position with the object’s endpoint.', pose: 'oops' },
            milestone: { text: 'The marker moved toward the endpoint. Keep counting equal quarter-inch spaces.', pose: 'think' },
            complete: { text: 'Your marker reaches 4¾ inches. Four quarter-inch spaces make one inch.', pose: 'cheer' },
          },
        },
      },
      {
    ...
    learnCards: [
      {
        ...
        widget: { type: 'balance-scale', config: { left: [{ id: 'three-feet', label: '3 feet', value: 36 }], right: [{ id: 'thirty-six-inches', label: '36 inches', value: 36 }], task: 'compare', lengthModel: { feet: 3, inches: 36 } } },
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Compare 3 feet with 36 inches. Predict first, then build foot strips from inch spaces.' },
            { speaker: 'kid', text: 'I will line up the lengths and use equal inch spaces to explain my comparison.' },
          ],
          reactions: {
            strategy: { text: 'Your prediction is saved. Build the strips to compare their endpoints.', pose: 'think' },
            retry: { text: 'Count the equal inch spaces in one complete foot strip.', pose: 'oops' },
            milestone: { text: 'The strips are built. Compare their aligned endpoints and the units.', pose: 'think' },
            complete: { text: 'Each foot has 12 inches. Three groups make 36 inches, so the two lengths are equivalent.', pose: 'cheer' },
          },
        },
      },
      {
