    ...
    learnCards: [
      {
        ...
        widget: { type: 'array-builder', config: { rows: 1, columns: 1, targetProduct: 234, editable: true, task: 'division', dividend: 936, divisor: 4, taskPrompt: 'Share 936 into 4 equal groups.' } },
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Share 936 into four equal groups. Choose useful amounts to put in every group.' },
            { speaker: 'kid', text: 'I will choose each amount and watch how much remains to share.' },
          ],
          reactions: {
            strategy: { text: 'Choose a whole-number amount that fits in each of the four groups.', pose: 'think' },
            retry: { text: 'Check that there is enough left to give the same amount to every group.', pose: 'oops' },
            milestone: { text: 'You shared an equal amount. Add it to each group’s running total.', pose: 'think' },
            complete: { text: 'Each group has 234 and none remain. Your partial quotients add to the full quotient.', pose: 'cheer' },
          },
        },
      },
      {
