...
const expectedWidgets = {
  ...
  'math-u04-l03-c1': { type: 'array-builder', config: { rows: 2, columns: 6, targetProduct: 12, targetRows: 4, targetColumns: 3, editable: true, taskPrompt: 'Build an array that shows four times as many as 3.' } },
} as const;
