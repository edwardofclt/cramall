    ...
    learnCards: [
      {
        ...
        widget: { type: 'place-value-builder', config: { periods: 3, target: 68405013 } },
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Let’s build 68,405,013. The commas split its digits into three periods.' },
            { speaker: 'kid', text: 'I will change the digits, then compare each period with the goal.' },
          ],
          reactions: {
            strategy: { text: 'Each place has its own value. Read the three-digit periods from left to right.', pose: 'think' },
            retry: { text: 'Compare the number you checked with the goal, one place at a time.', pose: 'oops' },
            milestone: { text: 'You checked how the periods fit together. Connect each group to its place name.', pose: 'think' },
            complete: { text: 'Your chart matches the goal. The same digits make standard, word, and expanded forms.', pose: 'cheer' },
          },
        },
      },
      {
      ...
      },
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Build 4,302. Watch how each place contributes to the expanded form.' },
            { speaker: 'kid', text: 'I will change the digits and check the value of each nonzero place.' },
          ],
          reactions: {
            strategy: { text: 'Name the column before naming the digit’s value.', pose: 'think' },
            retry: { text: 'Compare the number you checked with the goal, one place at a time.', pose: 'oops' },
            milestone: { text: 'Your check connects each digit to the amount it represents.', pose: 'think' },
            complete: { text: '4,302 is 4,000 + 300 + 2. The zero tens place adds no amount.', pose: 'cheer' },
          },
        },
      },
    ],
    ...
    learnCards: [
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Compare these two numbers on the line. Then move a marker to try a new comparison.' },
            { speaker: 'kid', text: 'I will use the positions and place values before I choose a symbol.' },
          ],
          reactions: {
            strategy: { text: 'Moving a marker changes its value. Compare the positions again.', pose: 'think' },
            retry: { text: 'Read both marker values and check which point is farther right.', pose: 'oops' },
            milestone: { text: 'You used the line to compare the two current values.', pose: 'think' },
            complete: { text: 'Your symbol matches the current marker positions. A farther-right point has a greater value.', pose: 'cheer' },
          },
        },
      },
      {
