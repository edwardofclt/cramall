    ...
    learnCards: [
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'A rectangle is 30 units by 4 units. Use the side lengths to work out its area.' },
            { speaker: 'kid', text: 'I will enter my total, then inspect the region to check my reasoning.' },
          ],
          reactions: {
            strategy: { text: 'Name the two side lengths of the region you selected.', pose: 'think' },
            retry: { text: 'Use the side lengths and count equal groups. Check the place value of your total.', pose: 'oops' },
            milestone: { text: 'Your total fits the side lengths. Connect it to the selected region.', pose: 'think' },
            complete: { text: 'The 30-by-4 model covers 120 square units.', pose: 'cheer' },
          },
        },
      },
      {
  ...
  },
  {
    ...
    learnCards: [
      ...
      },
      {
        ...
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Split a 23-by-14 rectangle into smaller regions. How can their areas help you find the whole?' },
            { speaker: 'kid', text: 'I will try a total, inspect each region, and compare the partial products.' },
          ],
          reactions: {
            strategy: { text: 'Use one row part and one column part for each region.', pose: 'think' },
            retry: { text: 'Add every partial area once. Check for a missing region or a place-value error.', pose: 'oops' },
            milestone: { text: 'Your total fits the factors. Inspect the remaining regions to connect the parts.', pose: 'think' },
            complete: { text: 'The four partial products add to 322, matching 23 × 14.', pose: 'cheer' },
          },
        },
      },
      {
    ...
    learnCards: [
      {
        ...
        widget: { type: 'array-builder', config: { rows: 2, columns: 6, targetProduct: 12, targetRows: 4, targetColumns: 3, editable: true, taskPrompt: 'Build an array that shows four times as many as 3.' } },
        widgetCoach: {
          intro: [
            { speaker: 'guide', pose: 'think', text: 'Show four times as many as 3 using equal rows of counters.' },
            { speaker: 'kid', text: 'I will choose the number of groups and the amount in each group, then check.' },
          ],
          reactions: {
            strategy: { text: 'Keep the number of groups separate from the amount in each group.', pose: 'think' },
            retry: { text: 'Check both the row count and the counters in each row.', pose: 'oops' },
            milestone: { text: 'Your groups match the comparison described in the problem.', pose: 'think' },
