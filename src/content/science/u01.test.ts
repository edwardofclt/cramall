  ...
  test('keeps every lesson schema-valid, canonically numbered, and on its exact widget allocation', () => {
    for (const lesson of unit01Lessons) {
      ...
      expect(lesson.learnCards.flatMap((card, index) => card.widget === undefined ? [] : [{ card: index + 1, value: card.widget }])).toEqual(
        ({
          'science-u01-l01': [{"card": 1, "value": {"type": "collision-ramp", "config": {"rampAngle": 0, "massA": 4, "massB": 4, "speedA": 5, "speedB": 2, "target": "compare-motion"}}}, {"card": 2, "value": {"type": "central-idea-organizer", "config": {"mainIdeaChoices": ["This comparison changes only the release height", "This comparison changes more than one condition"], "details": [{"id": "same-car", "text": "The same coaster car is used for both trips.", "supports": ["This comparison changes only the release height"]}, {"id": "same-track", "text": "The same track and the same two markers are used for both trips.", "supports": ["This comparison changes only the release height"]}, {"id": "height", "text": "Only the release height is changed between the two trips.", "supports": ["This comparison changes only the release height"]}, {"id": "swap-car", "text": "A heavier car is used for the second trip.", "supports": ["This comparison changes more than one condition"]}], "requiredDetailCount": 3}}}],
          'science-u01-l02': [{"card": 1, "value": {"type": "theme-evidence-collector", "config": {"themeChoices": ["The car had more energy of motion on the high-release trip", "The high-release trip was more fun to watch"], "evidence": [{"id": "marker-time", "text": "The car crossed the two bottom markers in less time after the high release.", "supports": ["The car had more energy of motion on the high-release trip"]}, {"id": "flag-distance", "text": "The car pushed the paper flag farther after the high release.", "supports": ["The car had more energy of motion on the high-release trip"]}, {"id": "favorite", "text": "The high hill is the observer's favorite part of the track.", "supports": ["The high-release trip was more fun to watch"]}, {"id": "bright-track", "text": "The track is painted a bright color.", "supports": ["The high-release trip was more fun to watch"]}], "requiredEvidenceCount": 2}}}, {"card": 2, "value": {"type": "energy-transfer-builder", "config": {"sources": ["car released from the high mark", "car released from the low mark"], "transfers": ["faster motion at the bottom", "slower motion at the bottom"], "targets": ["paper flag pushed farther", "paper flag pushed a shorter way"], "requiredPath": ["car released from the high mark", "faster motion at the bottom", "paper flag pushed farther"]}}}],
          'science-u01-l03': [{"card": 1, "value": {"type": "collision-ramp", "config": {"rampAngle": 0, "massA": 6, "massB": 3, "speedA": 4, "speedB": 0, "target": "compare-motion"}}}, {"card": 2, "value": {"type": "central-idea-organizer", "config": {"mainIdeaChoices": ["This question is testable", "This question is not testable"], "details": [{"id": "change-height", "text": "It names the marble release height as the one thing to change.", "supports": ["This question is testable"]}, {"id": "observe-block", "text": "It names how far the foam block moves as the thing to observe.", "supports": ["This question is testable"]}, {"id": "hold-same", "text": "It keeps the same marble, ramp, and block for every trial.", "supports": ["This question is testable"]}, {"id": "coolest", "text": "It asks which track looks coolest.", "supports": ["This question is not testable"]}], "requiredDetailCount": 3}}}],
          'science-u01-l04': [{"card": 2, "value": {"type": "collision-ramp", "config": {"rampAngle": 0, "massA": 4, "massB": 4, "speedA": 3, "speedB": 3, "target": "predict-direction"}}}],
        } as Record<string, unknown[]>)[lesson.id] ?? [],
      );
