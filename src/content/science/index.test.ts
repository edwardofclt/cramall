...
describe('Science lesson registry', () => {
  test('exposes only Unit 1 and makes all three authored lessons visible to the subject map', () => {
    const expectedLessonIds = ['science-u01-l01', 'science-u01-l02', 'science-u01-l03'];
