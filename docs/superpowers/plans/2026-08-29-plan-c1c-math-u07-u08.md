...
const expectedCards = {
  'math-u07-l01': [['math-u07-l01-c1', 'Keep the Denominator', 'like-denominator'], ['math-u07-l01-c2', 'Model a Fraction Operation', 'fraction-operation-model'], ['math-u07-l01-c3', 'Justify the Reasonableness', 'fraction-reasonableness']],
...
const expectedRoutes = {
  'math-u07-l01': [
      ['multiple-choice', 'like-denominator', 1],
      ['fill-blank', 'like-denominator', 1],
      ['true-false', 'like-denominator', 1],
      ['multiple-choice', 'like-denominator', 1],
      ['multiple-choice', 'fraction-operation-model', 2],
      ['fill-blank', 'fraction-operation-model', 2],
      ['true-false', 'fraction-operation-model', 2],
      ['multiple-choice', 'fraction-operation-model', 2],
...
const expectedWidgets = {
  'math-u07-l01-c2': { type: 'fraction-models', config: { mode: 'bars', denominator: 8, numerator: 3, target: { numerator: 5, denominator: 8 }, allowEquivalent: false } },
...
export const unit07Lessons = [
  {
    ...
    learnCards: [
      ...
      },
      {
        ...
        blocks: [
          { kind: 'text', text: 'A bar or number line can show selected parts being joined or removed.' },
          { kind: 'example', text: 'Starting at 3/8 and adding 2/8 lands at 5/8.' },
      ...
      {
        id: 'math-u07-l01-c3',
        title: 'Justify the Reasonableness',
        blocks: [
          { kind: 'text', text: 'Use 0, 1/2, 1, or a whole-number estimate to check the size of a sum or difference.' },
          { kind: 'example', text: '7/10 + 2/10 = 9/10 is reasonable because both addends total a little less than 1.' },
    ...
    quiz: {
      passThreshold: 8,
      pool: [
        { id: 'math-u07-l01-q01', type: 'multiple-choice', conceptTag: 'like-denominator', reviewCardId: 'math-u07-l01-c1', prompt: 'What is 3/8 + 2/8?', choices: [{ id: 'a', text: '5/8' }, { id: 'b', text: '5/16' }, { id: 'c', text: '1/8' }, { id: 'd', text: '6/8' }], correctChoiceId: 'a', explanation: 'The five selected parts are still eighths.' },
        { id: 'math-u07-l01-q02', type: 'fill-blank', conceptTag: 'like-denominator', reviewCardId: 'math-u07-l01-c1', prompt: 'Complete: 9/10 - 4/10 = ___.', acceptedAnswers: ['5/10'], explanation: 'Subtracting the numerators gives five tenths.' },
        { id: 'math-u07-l01-q03', type: 'true-false', conceptTag: 'like-denominator', reviewCardId: 'math-u07-l01-c1', prompt: '2/5 + 1/5 = 3/5.', choices: [{ id: 'true', text: 'True' }, { id: 'false', text: 'False' }], correctChoiceId: 'true', explanation: 'Two fifths plus one fifth makes three fifths.' },
        { id: 'math-u07-l01-q04', type: 'multiple-choice', conceptTag: 'like-denominator', reviewCardId: 'math-u07-l01-c1', prompt: 'What is 7/12 - 3/12?', choices: [{ id: 'a', text: '4/12' }, { id: 'b', text: '4/9' }, { id: 'c', text: '10/12' }, { id: 'd', text: '3/12' }], correctChoiceId: 'a', explanation: 'Seven twelfths minus three twelfths leaves four twelfths.' },
        { id: 'math-u07-l01-q05', type: 'multiple-choice', conceptTag: 'fraction-operation-model', reviewCardId: 'math-u07-l01-c2', prompt: 'A bar has 3 of 8 parts shaded, then 4 more eighths are shaded. Which equation matches?', choices: [{ id: 'a', text: '3/8 + 4/8 = 7/8' }, { id: 'b', text: '3/8 + 4/8 = 7/16' }, { id: 'c', text: '4/8 - 3/8 = 1/8' }, { id: 'd', text: '3/4 + 4/8 = 7/8' }], correctChoiceId: 'a', explanation: 'The same whole gains four more eighth-size parts.' },
        { id: 'math-u07-l01-q06', type: 'fill-blank', conceptTag: 'fraction-operation-model', reviewCardId: 'math-u07-l01-c2', prompt: 'Start at 2/6 on a number line and move forward 3/6. Where do you land?', acceptedAnswers: ['5/6'], explanation: 'Two sixths plus three sixths equals five sixths.' },
        { id: 'math-u07-l01-q07', type: 'true-false', conceptTag: 'fraction-operation-model', reviewCardId: 'math-u07-l01-c2', prompt: 'Removing 2/4 from 7/4 leaves 5/4.', choices: [{ id: 'true', text: 'True' }, { id: 'false', text: 'False' }], correctChoiceId: 'true', explanation: 'Seven fourths minus two fourths equals five fourths.' },
        { id: 'math-u07-l01-q08', type: 'multiple-choice', conceptTag: 'fraction-operation-model', reviewCardId: 'math-u07-l01-c2', prompt: 'Which story matches 9/10 - 3/10?', choices: [{ id: 'a', text: 'Nine tenths of a ribbon is used, then three tenths is cut away.' }, { id: 'b', text: 'Nine ribbons are joined to three ribbons.' }, { id: 'c', text: 'Three tenths is divided into nine groups.' }, { id: 'd', text: 'Nine tenths is compared with three fifths.' }], correctChoiceId: 'a', explanation: 'The story begins with nine tenths and removes three tenths.' },
        ...
        { id: 'math-u07-l01-q10', type: 'fill-blank', conceptTag: 'fraction-reasonableness', reviewCardId: 'math-u07-l01-c3', prompt: 'Complete: 13/8 - 4/8 = ___.', acceptedAnswers: ['9/8'], explanation: 'Subtracting the numerators leaves nine eighths.' },
  ...
  },
  {
    ...
    quiz: {
      ...
      pool: [
        ...
        { id: 'math-u07-l02-q10', type: 'fill-blank', conceptTag: 'fraction-product-situation', reviewCardId: 'math-u07-l02-c3', prompt: 'A recipe uses 1/3 cup of oats in each of 5 batches. It uses ___ cup in all.', acceptedAnswers: ['5/3'], explanation: 'Five copies of one third cup total five thirds cup.' },
...
const expectedCards = {
  ...
  'math-u08-l02': [['math-u08-l02-c1', 'Use 0, 0.5, and 1 as Benchmarks', 'decimal-benchmarks'], ['math-u08-l02-c2', 'Read Area and Linear Models', 'decimal-models'], ['math-u08-l02-c3', 'Choose and Justify a Comparison Symbol', 'decimal-comparison']],
...
export const unit08Lessons = [
  ...
  },
  {
    ...
    learnCards: [
      ...
      {
        id: 'math-u08-l02-c2',
        title: 'Read Area and Linear Models',
        blocks: [
          { kind: 'text', text: 'Area models compare shaded tenths or hundredths; number lines compare distance from 0.' },
          { kind: 'example', text: 'A grid with 64 hundredths shaded shows 0.64, farther from 0 than 0.6.' },
          { kind: 'tip', text: 'Use the same-sized whole and the same scale when comparing models.' },
        ],
      },
      {
        id: 'math-u08-l02-c3',
        ...
        blocks: [
          { kind: 'text', text: 'Compare ones first, then tenths, then hundredths; use =, <, or >.' },
          { kind: 'example', text: '0.70 = 0.7 because the extra zero does not change the value.' },
    ...
    workedExample: {
      ...
      steps: [
        ...
        'On a 0-to-1 number line, 0.58 lies left of 0.60, so 0.58 < 0.6.',
      ],
    },
    quiz: {
      passThreshold: 8,
      pool: [
        ...
        { id: 'math-u08-l02-q02', type: 'fill-blank', conceptTag: 'decimal-benchmarks', reviewCardId: 'math-u08-l02-c1', prompt: 'Complete with <, >, or =: 0.49 ___ 0.5.', acceptedAnswers: ['<'], explanation: 'Forty-nine hundredths is one hundredth below 0.50.' },
        ...
        { id: 'math-u08-l02-q05', type: 'multiple-choice', conceptTag: 'decimal-models', reviewCardId: 'math-u08-l02-c2', prompt: 'One grid shows 54 of 100 squares shaded. Another shows 6 of 10 strips shaded. Which comparison is true?', choices: [{ id: 'a', text: '0.54 < 0.6' }, { id: 'b', text: '0.54 > 0.6' }, { id: 'c', text: '0.54 = 0.6' }, { id: 'd', text: 'The models cannot be compared.' }], correctChoiceId: 'a', explanation: 'Six tenths is 60 hundredths, which is greater than 54 hundredths.' },
        ...
        { id: 'math-u08-l02-q08', type: 'multiple-choice', conceptTag: 'decimal-models', reviewCardId: 'math-u08-l02-c2', prompt: 'Which area model would show the greater amount?', choices: [{ id: 'a', text: '68 of 100 equal squares shaded' }, { id: 'b', text: '6 of 10 equal strips shaded' }, { id: 'c', text: '58 of 100 equal squares shaded' }, { id: 'd', text: '5 of 10 equal strips shaded' }], correctChoiceId: 'a', explanation: 'Sixty-eight hundredths is greater than 60, 58, and 50 hundredths.' },
        { id: 'math-u08-l02-q09', type: 'multiple-choice', conceptTag: 'decimal-comparison', reviewCardId: 'math-u08-l02-c3', prompt: 'Which comparison is true?', choices: [{ id: 'a', text: '0.70 = 0.7' }, { id: 'b', text: '0.70 < 0.7' }, { id: 'c', text: '0.70 > 0.7' }, { id: 'd', text: '0.70 = 0.07' }], correctChoiceId: 'a', explanation: 'A trailing zero does not change seven tenths.' },
        ...
        { id: 'math-u08-l02-q11', type: 'true-false', conceptTag: 'decimal-comparison', reviewCardId: 'math-u08-l02-c3', prompt: '0.58 < 0.6.', choices: [{ id: 'true', text: 'True' }, { id: 'false', text: 'False' }], correctChoiceId: 'true', explanation: 'Fifty-eight hundredths is less than 60 hundredths.' },
        ...
        { id: 'math-u08-l02-q13', type: 'fill-blank', conceptTag: 'decimal-comparison', reviewCardId: 'math-u08-l02-c3', prompt: 'Complete with <, >, or =: 0.84 ___ 0.48.', acceptedAnswers: ['>'], explanation: 'Eight tenths is greater than four tenths.' },
      ],
    },
  },
  {
    ...
    learnCards: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: 'example', text: '2.3 - 0.7 = 23/10 - 7/10 = 16/10 = 1.6.' },
    ...
    quiz: {
      ...
      pool: [
        ...
        { id: 'math-u08-l03-q09', type: 'multiple-choice', conceptTag: 'decimal-mixed-quantity', reviewCardId: 'math-u08-l03-c3', prompt: 'What is 2.3 - 0.7?', choices: [{ id: 'a', text: '1.6' }, { id: 'b', text: '2.4' }, { id: 'c', text: '1.4' }, { id: 'd', text: '3.0' }], correctChoiceId: 'a', explanation: 'Twenty-three tenths minus 7 tenths is 16 tenths, or 1.6.' },
