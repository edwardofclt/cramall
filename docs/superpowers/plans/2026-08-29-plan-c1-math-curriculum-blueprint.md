...
- `math-u07-l01` “Add and Subtract Like-Denominator Fractions” / `['4.PAFR.2.1']`: c1 “Keep the Denominator” / `like-denominator`; c2 “Model a Fraction Operation” / `fraction-operation-model`; c3 “Justify the Reasonableness” / `fraction-reasonableness`.
...
- `math-u07-l01`: q01 MC `like-denominator` -> c1; q02 FB `like-denominator` -> c1; q03 TF `like-denominator` -> c1; q04 MC `like-denominator` -> c1; q05 MC `fraction-operation-model` -> c2; q06 FB `fraction-operation-model` -> c2; q07 TF `fraction-operation-model` -> c2; q08 MC `fraction-operation-model` -> c2; q09 MC `fraction-reasonableness` -> c3; q10 FB `fraction-reasonableness` -> c3; q11 TF `fraction-reasonableness` -> c3; q12 MC `fraction-reasonableness` -> c3; q13 MC `fraction-reasonableness` -> c3.
